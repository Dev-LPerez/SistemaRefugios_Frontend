    ...
    <div class="space-y-6 animate-[fadeIn_0.4s_ease-out]">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-4 flex flex-col justify-between relative overflow-hidden group shadow-md">
          ...
          <p class="text-2xl font-bold text-emerald-600 mt-2 z-10">{{ recursosDistribuidos }}</p>
        </div>
      ...
      <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-md">
        ...
        <div v-else class="overflow-x-auto">
          <table class="w-full text-left border-collapse">
            <thead>
              <tr class="bg-emerald-50/80 border-b border-emerald-200 text-[10px] uppercase tracking-wider text-emerald-800 font-bold animate-[fadeIn_0.3s_ease-out]">
            ...
            <tbody class="text-xs text-slate-700">
              <tr v-for="item in paginados" :key="item.id_entrega" class="odd:bg-white even:bg-emerald-50/20 hover:bg-emerald-100/30 transition-colors">
                ...
                <td class="px-5 py-4 text-center font-bold text-emerald-700 border-b border-slate-100/40">{{ item.cantidad_entregada }}</td>
